...
class NumericArray(private val values: DoubleArray) {
    ...
    operator fun plus(that: Double): NumericArray = narrayOf(*this.values.map { it + that }.toDoubleArray())
    operator fun plus(that: Int): NumericArray = narrayOf(*this.values.map { it + that }.toDoubleArray())
    ...
    operator fun minus(that: Double): NumericArray = narrayOf(*this.values.map { it - that }.toDoubleArray())
    operator fun minus(that: Int): NumericArray = narrayOf(*this.values.map { it - that }.toDoubleArray())
    ...
    operator fun times(that: Double): NumericArray = narrayOf(*this.values.map { it * that }.toDoubleArray())
    operator fun times(that: Int): NumericArray = narrayOf(*this.values.map { it * that }.toDoubleArray())
    ...
    operator fun div(that: Double): NumericArray = narrayOf(*this.values.map { it / that }.toDoubleArray())
